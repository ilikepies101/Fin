...
namespace Interview.Tests.Unit.HelperObjects
{
    ...
    /// for an unbalanced balance sheet. The balance sheet is identical to 
    /// ./TestBalanceSheet.cs, but the "Accounts Receivable" line is
    /// debited by one to make it unbalanced.
    /// </summary>
    public static class TestBalanceSheet_Unbalanced
    {
        /// <summary>
                        ...
                        new LineItem
                        {
                            ...
                            Sublines = new List<LineItem>
                            {
                                new LineItem
                                {
                                    ...
                                    // Change in Amount from original ./TestBalanceSheet.cs
                                    Amount = new LedgerAmount(50_001, CreditOrDebit.Debit),
                                },
                                new LineItem
                                {
